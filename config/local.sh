...
/home/forest/Documents/node_planner/deploy_scripts/node_planner.service \
ec2-user@ec2-52-56-147-199.eu-west-2.compute.amazonaws.com:/home/ec2-user
scp -i ~/.ssh/aws/portfolio-apps-key.pem \
/home/forest/Documents/star-wars-planets/config/star-wars-planets.service \
ec2-user@ec2-52-56-147-199.eu-west-2.compute.amazonaws.com:/home/ec2-user
...
# .env files
scp -i ~/.ssh/aws/portfolio-apps-key.pem \
/home/forest/Documents/node_planner/.env \
